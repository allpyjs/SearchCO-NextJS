...
const Dialog: FC<DialogProps> = ({ open, onClose, fetchStoreData, id }) => {
    ...
    const handleDelete = async () => {
        try {
            ...
            const storeRef = collection(db, "website-search");
            ...
            try {
                ...
                toast.success("Website Data store was deleted successfully.")
                fetchStoreData();
                onClose();
            } catch (error) {
                console.error("Failed to delete Website data store:", error);
            }
        }
        catch (error) {
            console.error("Failed to delete Website data store:", error);
                    ...
                    <div className="fixed inset-0 z-10 overflow-hidden">
                        <div className="flex min-h-screen items-center justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                            ...
                            <div
                                ...
                                role="dialog"
                            >
                                <div className="text-3xl font-bold text-black dark:text-neutral-200 mb-[20px]">Delete a Datastore</div>
                                <div>Will you really delete the datastore?</div>
