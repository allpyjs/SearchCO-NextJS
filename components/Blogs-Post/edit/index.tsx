...
import { collection, addDoc, updateDoc, DocumentReference, DocumentData, getDocs, where, query } from 'firebase/firestore';
...
const getFileNameFromFirebaseStorageUrl = (url) => {
    try {
...
const Page = ({ id }: PageProps) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const uniqueFileName = getFileNameFromFirebaseStorageUrl(imageUrl);
            ...
            toast.success("Your Blog was updated successfully.")
    ...
    return (
        <div className="w-full p-4 flex flex-col items-center pb-[100px]">
            <div className="w-full flex justify-center text-[30px] font-bold">Update Blog Post</div>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='flex gap-3'>
                        ...
                        >
                            ...
                            <span>{!isBlogSaving ? "Update" : "Updating"}</span>
                        </button>
                    </div>
                </form>
            </div>
