...
type DropdownButtonProps = {
    ...
    handlePublic: (id: string) => void;
}

const DropDownDatastoreAction = ({ id, handleDelete, handleEdit, handleEmbedDialog, handlePublic }: DropdownButtonProps) => {
            ...
            {isDropdownOpen && (
                <div id="dropdownDots" style={{ position: 'absolute', zIndex: 1000, top: '40px', right: '20px' }}
                    ...
                    <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconButton">
                        <li>
                            <Link href={`/file-search/chat/${id.slice(5)}`} className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white cursor-pointer">Chat</Link>
                        </li>
                        {/* <li>
                            <div className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white cursor-pointer" onClick={() => { setIsDropdownOpen(false); handlePublic(id) }} >Make as public</div>
                        </li> */}
                        <li>
                        ...
                        <li>
                            <Link href={`/file-search/datastore/${id.slice(5)}`} className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white cursor-pointer">Documents</Link>
                        </li>
                        <li>
